...
public class ArticleBloc {
    ...
    public ArticleBloc(final ArticleService articleService, final CategoryService categoryService, final UserCategoryService userCategoryService, final SessionService sessionService, final ScoreService scoreService) {
...
//                     .collect(Collectors.toList());
    ...
    public List<Integer> getNumberOfArticlesPerCategory(int numberOfArticles, int numberOfCategories) {
        List<Integer> numberOfArticlesPerCategory = new ArrayList<>();

//        for (int i = 0; i < numberOfCategories; i++) {
//            numberOfArticlesPerCategory.add(numberOfArticles / numberOfCategories);
//        }
...
//        for (int i = 0; i < r; i++) {
//            numberOfArticlesPerCategory.set(i, numberOfArticlesPerCategory.get(i) + 1);
//        }
